...
```bash
git clone https://github.com/Tejasree-SRH-Thesis/Phi3.5-mini-Instruct.git
cd Phi3.5-mini-Instruct
```
...
- Phi-3.5-mini-instruct-GGUF : AI model for natural language understanding and generation
